...
```
   JIM.getGroupInfo({
                  ...
                  //data.group_info.avatar 群头像
                  //data.group_info.group_type 公开群:2,私有群:0或者1
               }).onFail(function(data) {
                   //data.code 返回码
                   //data.message 描述
               });
...
```
   JIM.getAppkeyChatrooms({
                   ...
                   //data.result.rooms[].ctime 聊天室创建时间
