...
function setPageSize() {
    ...
    if (w < 800) {
        ...
        $("#top-title").css({"margin-top": "90"+"px", "margin-bottom": "-32"+"px"});
        $("html").css({"overflow-x":"hidden", "width":w+"px"});
        if ($("#phone-head-menu").length <= 0) {
            var menu = '\
            <select id="phone-head-menu" onchange=mbar(this) style="position: absolute; top: 14px; right: 35px;font-weight: 600; -webkit-box-shadow: 0 3px 0 #ccc,0 -1px #fff inset; -moz-box-shadow: 0 3px 0 #ccc,0 -1px #fff inset; box-shadow: 0 3px 0 #ccc,0 -1px #fff inset; background: #1b75bb; color: #fff; font-size: 14px; border: none; outline: none;display: inline;-webkit-appearance: none;-moz-appearance: none;cursor: pointer;-webkit-border-radius: 0px;-moz-border-radius: 0px;border-radius: 0px;width: 62px;">\
                <option>菜单 +</option>\
