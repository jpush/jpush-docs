...
本 iOS SDK 方便开发者基于 JMessage 来快捷地为 iOS App 增加 IM 功能。
...
JMessage.framework 里的 Headers 目录下，有多个头文件。

```
JMessage.h         // SDK 核心类，提供启动方法，以及全局的定义与方法
...
JMessage 提供了如下类型的通知，可以注册 NSNotificationCenter 来监听，以做进一步的逻辑处理。这些是可选的。
