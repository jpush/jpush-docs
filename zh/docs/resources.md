                                          ...
                                          <table widht="100%">
                                                <tr>
                                                      ...
                                                      <td style="padding: 20px 0;">
                                                            ...
                                                            <p style="margin: 2px 0;">版本号：v3.2.5</p>
                                                            <p style="margin: 2px 0;">更新时间：2015-06-25</p>
                                                            ...
                                                            <p><a href="http://docs.jpush.cn/download/attachments/2228302/jpush-client-3.2.5.zip?version=1&modificationDate=1435717731066" style="display: inline-block; height: 30px; line-height: 30px; width: 100px; border: 1px solid #ccc;border-radius: 3px;color: #999;text-align: center;">
                                          ...
                                          <table widht="100%">
                                                <tr>
                                                      ...
                                                      <td style="padding: 20px 0;">
                                                            ...
                                                            <p style="margin: 2px 0 10px;">支持：Push API v3, Report API, Device API</p>
                                                            <p><a href="http://docs.jpush.cn/download/attachments/2228302/jpush-api-php-client-3.2.3.zip?version=2&modificationDate=1435817904060" style="display: inline-block; height: 30px; line-height: 30px; width: 100px; border: 1px solid #ccc;border-radius: 3px;color: #999;text-align: center;">
                                                                  <i style="vertical-align: middle; display: inline-block; width: 11px; height: 11px; background: url(../image/resource_sdk_download.png) 0 0;"></i>&nbsp;&nbsp;下载
                                                            </a></p>
                                                      </td>
                                                </tr>
