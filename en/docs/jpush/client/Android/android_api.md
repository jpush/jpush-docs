...
After calling this API, the JPush push service is completely stopped. Specifically:
    ...
    • All other API calls of JPush are invalid and can not be recovered by JPushInterface.init but by calling resumePush.
...
Functional Description
The user clicked on the notification. In general, users do not need to configure this receiver action.
...
Related Documents
    • Android SDK Tag and Alias API
    • iOS SDK Tag and Alias API
